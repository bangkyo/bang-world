...
namespace SystemControlClassLibrary
{
    public partial class CrtOrd : Form
    {
        ...
        private void InitGrid()
        {
            ...
            grdMain.Cols["LINE"             ].Caption = "편성라인";
            ...
            grdMain.Cols["LINE"             ].TextAlign = cs.POC_PROG_STAT_NM_TextAlign;
            ...
            grdMain.Cols["LINE"             ].Width = cs.POC_PROG_STAT_NM_Width;
        ...
        private bool SetDataBinding()
        {
            try
            {
                ...
                sql1 += string.Format("               ,NVL(LINE_GP,'미편성') AS LINE  ");
