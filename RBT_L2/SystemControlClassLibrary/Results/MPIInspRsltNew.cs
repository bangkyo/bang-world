...
{
    public partial class MPIInspRsltNew : Form
    {
        ...
        public MPIInspRsltNew(string titleNm, string scrAuth, string factCode, string ownerNm)
        {
            ownerNM = ownerNm;
            titleNM = titleNm;
        ...
        private void MPIInspRsltNew_Load(object sender, EventArgs e)
        {
            InitControl();
        ...
        private void InitGrd_Main()
        {
            ...
            var crCellRange = grdMain.GetCellRange(1, grdMain.Cols["A11_PCS"].Index);
            ...
            grdMain[1, "MLFT_NG_PCS"] = grdMain.Cols["MLFT_NG_PCS"].Caption;
            grdMain.Rows[1].StyleNew.Font = new Font("돋움", 11.0f, FontStyle.Bold);
            ...
            grdMain[1, "FAULT_CD"] = grdMain.Cols["FAULT_CD"].Caption;
            grdMain.Rows[1].StyleNew.Font = new Font("돋움", 11.0f, FontStyle.Bold);

            grdMain[1, "A11_PCS"] = "  종크랙\n\rAR0";
            grdMain[1, "A12_PCS"] = "  입계크랙\n\rA2";
            grdMain[1, "A13_PCS"] = "  횡크랙\n\rAR5";
            grdMain[1, "A14_PCS"] = "  단발성딱지흠\n\rBR1";
            grdMain[1, "A15_PCS"] = "  겹침성딱지흠\n\rBX3";
            grdMain[1, "A16_PCS"] = "  접힘\n\rBR2";
            grdMain[1, "A17_PCS"] = "  Wrinkle\n\rBR3";
            grdMain[1, "B11_PCS"] = "  긁힘\n\rB12";
            grdMain[1, "B12_PCS"] = "  이물혼입\n\rB3";
            grdMain[1, "B13_PCS"] = "  비금속개재물\n\rAR9";
            grdMain[1, "B14_PCS"] = "  교정롤마크\n\rBS1";
            grdMain[1, "B15_PCS"] = "  공형흠\n\rBR8";
            grdMain[1, "B16_PCS"] = "  DENT(눌림)\n\rBR7";
            grdMain[1, "B17_PCS"] = "  정정긁힘\n\rB2";
            ...
            grdMain.Cols["MFG_DATE"].Width = level3;
            grdMain.Cols["HEAT"].Width = level3;
            grdMain.Cols["POC_NO"].Width = level3;
            grdMain.Cols["MLFT_NG_PCS"].Width = 70;
            grdMain.Cols["WORK_PCS"].Width = 70;
            grdMain.Cols["OK_PCS"].Width = 70;
            grdMain.Cols["FAULT_PCS"].Width = 70;
            grdMain.Cols["GUBUN"].Width = 0;

            grdMain.Cols["A11_PCS"].Width = level2_5;
            grdMain.Cols["A12_PCS"].Width = level2_5;
            grdMain.Cols["A13_PCS"].Width = level2_5;
            grdMain.Cols["A14_PCS"].Width = level3;
            grdMain.Cols["A15_PCS"].Width = level3;
            grdMain.Cols["A16_PCS"].Width = 70;
            grdMain.Cols["A17_PCS"].Width = 70;
            grdMain.Cols["B11_PCS"].Width = level2_5;
            grdMain.Cols["B12_PCS"].Width = level2_5;
            grdMain.Cols["B13_PCS"].Width = level3;
            grdMain.Cols["B14_PCS"].Width = level3;
            grdMain.Cols["B15_PCS"].Width = level2_5;
            grdMain.Cols["B16_PCS"].Width = level3;
            grdMain.Cols["B17_PCS"].Width = 70;
            
            grdMain.Cols["ETC_PCS"].Width = level2_5;
            grdMain.Cols["FAULT_CD"].Width = level3;
            ...
            grdMain.Cols["MLFT_NG_PCS"].TextAlign = cs.PCS_TextAlign;
            ...
            grdMain.Cols["A11_PCS"].TextAlign = cs.PCS_TextAlign;
            grdMain.Cols["A12_PCS"].TextAlign = cs.PCS_TextAlign;
            grdMain.Cols["A13_PCS"].TextAlign = cs.PCS_TextAlign;
            grdMain.Cols["A14_PCS"].TextAlign = cs.PCS_TextAlign;
            grdMain.Cols["A15_PCS"].TextAlign = cs.PCS_TextAlign;
            grdMain.Cols["A16_PCS"].TextAlign = cs.PCS_TextAlign;
            grdMain.Cols["A17_PCS"].TextAlign = cs.PCS_TextAlign;
            grdMain.Cols["B11_PCS"].TextAlign = cs.PCS_TextAlign;
            grdMain.Cols["B12_PCS"].TextAlign = cs.PCS_TextAlign;
            grdMain.Cols["B13_PCS"].TextAlign = cs.PCS_TextAlign;
            grdMain.Cols["B14_PCS"].TextAlign = cs.PCS_TextAlign;
            grdMain.Cols["B15_PCS"].TextAlign = cs.PCS_TextAlign;
            ...
            grdMain.Cols["FAULT_CD"].TextAlign = cs.HEAT_TextAlign;
            ...
            grdMain.Cols["MFG_DATE"].AllowEditing = true;
            grdMain.Cols["MLFT_NG_PCS"].AllowEditing = false;
            grdMain.Cols["WORK_PCS"].AllowEditing = false;
            grdMain.Cols["OK_PCS"].AllowEditing = true;
            grdMain.Cols["FAULT_PCS"].AllowEditing = false;
            grdMain.Cols["A11_PCS"].AllowEditing = true;
            grdMain.Cols["A12_PCS"].AllowEditing = true;
            grdMain.Cols["A13_PCS"].AllowEditing = true;
            grdMain.Cols["A14_PCS"].AllowEditing = true;
            grdMain.Cols["A15_PCS"].AllowEditing = true;
            grdMain.Cols["A16_PCS"].AllowEditing = true;
            grdMain.Cols["A17_PCS"].AllowEditing = true;
            grdMain.Cols["B11_PCS"].AllowEditing = true;
            grdMain.Cols["B12_PCS"].AllowEditing = true;
            grdMain.Cols["B13_PCS"].AllowEditing = true;
            grdMain.Cols["B14_PCS"].AllowEditing = true;
            grdMain.Cols["B15_PCS"].AllowEditing = true;
            grdMain.Cols["B16_PCS"].AllowEditing = true;
            grdMain.Cols["B17_PCS"].AllowEditing = true;

            grdMain.Cols["ETC_PCS"].AllowEditing = true;
            grdMain.Cols["FAULT_CD"].AllowEditing = true;
        ...
        private void setDataBinding()
        {
            ...
            sql1 += string.Format("       ,NVL(A11_PCS, 0) AS A11_PCS ");
            sql1 += string.Format("       ,NVL(A12_PCS, 0) AS A12_PCS ");
            sql1 += string.Format("       ,NVL(A13_PCS, 0) AS A13_PCS ");
            sql1 += string.Format("       ,NVL(A14_PCS, 0) AS A14_PCS ");
            sql1 += string.Format("       ,NVL(A15_PCS, 0) AS A15_PCS ");
            sql1 += string.Format("       ,NVL(A16_PCS, 0) AS A16_PCS ");
            sql1 += string.Format("       ,NVL(A17_PCS, 0) AS A17_PCS ");
            ...
            sql1 += string.Format("              ,SUM(DECODE(ROUTING_CD,'H2', DECODE(GOOD_YN,'NG',DECODE(A.MPI_FAULT_CD,'AR0',1,0)) )) A11_PCS  "); //--종크랙
            sql1 += string.Format("              ,SUM(DECODE(ROUTING_CD,'H2', DECODE(GOOD_YN,'NG',DECODE(A.MPI_FAULT_CD,'A2',1,0)) )) A12_PCS  "); //--입계크랙
            sql1 += string.Format("              ,SUM(DECODE(ROUTING_CD,'H2', DECODE(GOOD_YN,'NG',DECODE(A.MPI_FAULT_CD,'AR5',1,0)) )) A13_PCS  "); //--횡크랙
            sql1 += string.Format("              ,SUM(DECODE(ROUTING_CD,'H2', DECODE(GOOD_YN,'NG',DECODE(A.MPI_FAULT_CD,'BR1',1,0)) )) A14_PCS  "); //--단발성딱지흠
            sql1 += string.Format("              ,SUM(DECODE(ROUTING_CD,'H2', DECODE(GOOD_YN,'NG',DECODE(A.MPI_FAULT_CD,'BX3',1,0)) )) A15_PCS  "); //--겹침성딱지흠
            sql1 += string.Format("              ,SUM(DECODE(ROUTING_CD,'H2', DECODE(GOOD_YN,'NG',DECODE(A.MPI_FAULT_CD,'BR2',1,0)) )) A16_PCS  "); //--접힘
            sql1 += string.Format("              ,SUM(DECODE(ROUTING_CD,'H2', DECODE(GOOD_YN,'NG',DECODE(A.MPI_FAULT_CD,'BR3',1,0)) )) A17_PCS  "); //--입계크랙

            sql1 += string.Format("              ,SUM(DECODE(ROUTING_CD,'H2', DECODE(GOOD_YN,'NG',DECODE(A.MPI_FAULT_CD,'B12',1,0)) )) B11_PCS  "); //--긁힘
            sql1 += string.Format("              ,SUM(DECODE(ROUTING_CD,'H2', DECODE(GOOD_YN,'NG',DECODE(A.MPI_FAULT_CD,'B3',1,0)) )) B12_PCS  "); //--이물혼입
            sql1 += string.Format("              ,SUM(DECODE(ROUTING_CD,'H2', DECODE(GOOD_YN,'NG',DECODE(A.MPI_FAULT_CD,'AR9',1,0)) )) B13_PCS  "); //--비금속개재물
            sql1 += string.Format("              ,SUM(DECODE(ROUTING_CD,'H2', DECODE(GOOD_YN,'NG',DECODE(A.MPI_FAULT_CD,'BS1',1,0)) )) B14_PCS  "); //--교정롤마크
            sql1 += string.Format("              ,SUM(DECODE(ROUTING_CD,'H2', DECODE(GOOD_YN,'NG',DECODE(A.MPI_FAULT_CD,'BR8',1,0)) )) B15_PCS  "); //--공형흠
            sql1 += string.Format("              ,SUM(DECODE(ROUTING_CD,'H2', DECODE(GOOD_YN,'NG',DECODE(A.MPI_FAULT_CD,'BR7',1,0)) )) B16_PCS  "); //--DENT(눌림)
            sql1 += string.Format("              ,SUM(DECODE(ROUTING_CD,'H2', DECODE(GOOD_YN,'NG',DECODE(A.MPI_FAULT_CD,'B2',1,0)) )) B17_PCS  "); //--정정긁힘
            sql1 += string.Format("              ,SUM(DECODE(ROUTING_CD,'H2',DECODE(GOOD_YN, 'NG',CASE WHEN A.MPI_FAULT_CD IN ('AR0','A2','AR5','BR1','BX3', 'BR2', 'BR3', 'B12','B3','AR9','BS1', 'BR8', 'BR7', 'B2') THEN 0 ");
            sql1 += string.Format("                    ELSE 1  END)))  AS ETC_PCS "); //--기타
            sql1 += string.Format("        FROM (SELECT MILL_NO, PIECE_NO, LINE_GP, ROUTING_CD, REWORK_SEQ, POC_NO, MFG_DATE, HEAT, GOOD_YN, ");
            ...
            else
            {
                ...
                sql1 += string.Format("               WHERE POC_NO       IN ( SELECT DISTINCT POC_NO FROM  TB_CR_PIECE_WR ");
                sql1 += string.Format("                                         WHERE  ROUTING_CD  IN ( 'H2', 'F2') ");
                sql1 += string.Format("                                         AND   LINE_GP    = '{0}' ", cd_id); //P_LINE_GP
                sql1 += string.Format("                                         AND   MFG_DATE   = '{0}' ) ", mfg_date); //P_MFG_DATE
            }
            sql1 += string.Format("                  AND   LINE_GP    = '{0}' ", cd_id); //P_LINE_GP
            sql1 += string.Format("                  AND   ROUTING_CD IN( 'H2', 'F2') ");
            //sql1 += string.Format("                  AND   V.REWORK_SEQ   = ( SELECT MAX(REWORK_SEQ) FROM TB_CR_PIECE_WR    ");
            ...
            sql1 += string.Format("        GROUP BY POC_NO, MFG_DATE, STEEL, HEAT, ITEM_SIZE ");
            sql1 += string.Format("        ORDER BY POC_NO, MFG_DATE ");
            //sql1 += string.Format("        GROUP BY ROLLUP(WORK_TYPE, (ITEM_SIZE, STEEL, HEAT, POC_NO)) ");
