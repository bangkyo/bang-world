...
namespace SystemControlClassLibrary
{
    public partial class SHTRslt : Form
    {
        ...
        private void InitgrdMain1()
        {
            ...
            grid.Cols["L_NO"].Width = cs.L_No_Width;
            grid.Cols["MFG_DATE"].Width = cs.Date_8_Width + 10;
        ...
        private void UpdateTotals(C1FlexGrid grid)
        {
            ...
            grid.Subtotal(AggregateEnum.Sum, subtotalNo, -1, grid.Cols["MILL_PCS"].Index, "합계");
            grid.Subtotal(AggregateEnum.Sum, subtotalNo, -1, grid.Cols["MILL_WGT"].Index, "합계");

            grid.Subtotal(AggregateEnum.Sum, subtotalNo, -1, grid.Cols["STR_PCS"].Index, "합계");
            grid.Subtotal(AggregateEnum.Sum, subtotalNo, -1, grid.Cols["STR_WGT"].Index, "합계");

            grid.Subtotal(AggregateEnum.Sum, subtotalNo, -1, grid.Cols["SHF_PCS"].Index, "합계");
            grid.Subtotal(AggregateEnum.Sum, subtotalNo, -1, grid.Cols["SHF_WGT"].Index, "합계");

            grid.Subtotal(AggregateEnum.Sum, subtotalNo, -1, grid.Cols["SHT_PCS"].Index, "합계");
            grid.Subtotal(AggregateEnum.Sum, subtotalNo, -1, grid.Cols["SHT_WGT"].Index, "합계");
