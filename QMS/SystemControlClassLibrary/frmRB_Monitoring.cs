...
{
    public partial class frmRB_Monitoring : Form
    {
        Timer t = new Timer();

        public frmRB_Monitoring()
        {
            InitializeComponent();
        }
        ...
        public frmRB_Monitoring(string titleNm, string scrAuth, string factCode, string ownerNm)
        {
            ck.StrKey1 = "";
            ck.StrKey2 = "";
        ...
        private void frmRB_Monitoring_Load(object sender, EventArgs e)
        {
            InitControl();
        ...
        {
            var temp_form = GetForm("frmRB_Monitoring4");


            if (temp_form == null)
            {
                var sub = new frmRB_Monitoring4("특수강입고현황", "S", "", "특수강입고현황");
