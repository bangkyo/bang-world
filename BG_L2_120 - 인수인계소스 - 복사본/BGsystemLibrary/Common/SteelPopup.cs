...
{
    public partial class SteelPopup : Form
    {
        //공통
        ...
        private void SteelPopup_Load(object sender, EventArgs e)
        {
            txt_CD_NM.Text = ck.StrKey1;
            DrawGrid(grdMain);
            Seach();
        }
        ...
        {
            ck.StrKey2 = grdMain.GetData(grdMain.RowSel, "CD_ID").ToString();


            this.Close();
        }

        private void txt_CD_NM_TextChanged(object sender, EventArgs e)
        {
