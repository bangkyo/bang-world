...
namespace ComLib
{
    public class clsStyle
    {
        ...
        //clsFlexGrid clsFlexGrid = new clsFlexGrid();
        ...
        public const int TOP_ROW_HEIGHT = 2;

        public void ChartLineColors()
        {
            Color[] ChartColors = new Color[8]{
                Color.Purple,
                Color.SteelBlue,
                Color.Aqua,
                Color.Yellow,
        ...
        static float fontSizeSmall = 10.0f;
        static float oHeadfontSize = 10.0f;
        static float fontSizeRegular = 9.0f;
        //static int oHeadfontStyle = 1;
        static string oHeadfontName = "돋움체";
        ...
        TextAlignEnum _ITEM_NM_TextAlign = TextAlignEnum.CenterCenter;
        TextAlignEnum _ITEM_COLOR_TextAlign = TextAlignEnum.CenterCenter;
        TextAlignEnum _MinMaxCk_TextAlign = TextAlignEnum.CenterCenter;
        TextAlignEnum _ALLOW_MIN_TextAlign = TextAlignEnum.CenterCenter;
        TextAlignEnum _ALLOW_MAX_TextAlign = TextAlignEnum.CenterCenter;
        TextAlignEnum _FACTORYA_NM_TextAlign = TextAlignEnum.CenterCenter;
        TextAlignEnum _ROUTING_CDA_TextAlign = TextAlignEnum.CenterCenter;
        TextAlignEnum _ROUTING_NM_TextAlign = TextAlignEnum.CenterCenter;
        TextAlignEnum _PLC_ADDRESS_TextAlign = TextAlignEnum.CenterCenter;
        ...
        {
            cb.Font = new Font(OHeadfontName, FontSizeSmall, FontStyle.Regular);
            //cb.DropDownStyle = ComboBoxStyle.DropDownList;
        ...
        public void InitGrid(C1FlexGrid sender)
        {
            ...
            fg.Rows[0].StyleNew.Font = new Font("맑은 고딕", 11.0f, FontStyle.Bold);
        ...
        public void InitGrid_search(C1FlexGrid sender)
        {
            ...
            //    fg.ser .Series[col].Color = ChartColors[i++];
            //}
            ...
            //fg.Font = new Font("맑은 고딕", 11.0f, FontStyle.Bold);
            ...
            fg.Styles["Highlight"].BackColor = SystemColors.Highlight;
            fg.Styles["EmptyArea"].BackColor = Color.FromArgb(219, 233, 246);
            ...
            //header 색 지정
            csCellStyle.BackColor = Color.FromArgb(255, 219, 233, 246);
            //->
            //var crCellRange = fg.GetCellRange(0, 0, 0, fg.Cols.Count-1);
            var crCellRange = fg.GetCellRange(0, 0, 0, fg.Cols.Count - 1);
            crCellRange.Style = fg.Styles["CellStyle"];
        ...
        public void InitGrid_temp(C1FlexGrid sender)
        {
            ...
            for (int col = 0; col < fg.Cols.Count; col++)
            {
                fg.Cols[col].StyleNew.Font = new Font("맑은 고딕", 11.0f);
            }
            fg.Rows[0].StyleNew.Font = new Font("맑은 고딕", 11.0f, FontStyle.Bold);
        ...
        public void InitPanel(Panel panel)
        {
            ...
            panel.BackColor = Color.FromArgb(255, 219, 233, 246);
        }
        ...
        //2016.06.08 OCJ 추가
        //시리즈 별 색깔 추가
        public Color ColorBySeries(int nNumber)
        {
            Color color;
            ...
            {
                case 0:
                    color = Color.FromArgb(39, 132, 212);
                    break;
                case 1:
                    color = Color.FromArgb(69, 168, 88);
                    break;
                case 2:
                    color = Color.FromArgb(240, 125, 16);
                    break;
                case 3:
                    color = Color.FromArgb(168, 89, 178);
                    break;
                case 4:
                    color = Color.FromArgb(204, 71, 72);
                    break;
                case 5:
                    color = Color.FromArgb(32, 79, 171);
                    break;
                case 6:
                    color = Color.FromArgb(167, 169, 23);
                    break;
                case 7:
                    color = Color.FromArgb(146, 49, 103);
                    break;
                case 8:
                    color = Color.FromArgb(255, 169, 1);
                    break;
                case 9:
                    color = Color.FromArgb(242, 99, 119);
                    break;
                default:
        ...
        public Color ColorBySeriesTransparent(int SeriesIndex, int TransColor)
        {
            Color color;
            ...
            {
                case 0:
                    color = Color.FromArgb(TransColor, 39, 132, 212);
                    break;
                case 1:
                    color = Color.FromArgb(TransColor, 69, 168, 88);
                    break;
                case 2:
                    color = Color.FromArgb(TransColor, 240, 125, 16);
                    break;
                case 3:
                    color = Color.FromArgb(TransColor, 168, 89, 178);
                    break;
                case 4:
                    color = Color.FromArgb(TransColor, 204, 71, 72);
                    break;
                case 5:
                    color = Color.FromArgb(TransColor, 32, 79, 171);
                    break;
                case 6:
                    color = Color.FromArgb(TransColor, 167, 169, 23);
                    break;
                case 7:
                    color = Color.FromArgb(TransColor, 146, 49, 103);
                    break;
                case 8:
                    color = Color.FromArgb(TransColor, 255, 169, 1);
                    break;
                case 9:
                    color = Color.FromArgb(TransColor, 242, 99, 119);
                    break;
                default:
                    color = Color.FromArgb(255, 0, 0);
                    break;
        ...
        //그리드 캡션의 테두리 색깔
        public Color ColorByCaptionBorder()
        {
            Color color = Color.FromArgb(203, 206, 210);
            return color;
        }

        //그리드 캡션의 배경색 
        public Color ColorByCaptionBackGround()
        {
            Color color = Color.FromArgb(219, 233, 246);
            return color;
        }

        //그리드 캡션의 전경색 
        public Color ColorByCaptionForeGround()
        {
            Color color = Color.FromArgb(73, 69, 70);
            return color;
        }

        //가장 상위 부분은 테두리 색깔
        public Color ColorByTopBorder()
        {
            Color color = Color.FromArgb(55, 76, 103);
            return color;
        }

        //합계 셀에 대한 색깔 정의
        public Color ColorBySumCell()
        {
            Color color = Color.FromArgb(242, 242, 242);
            return color;
        }

        //총 합계에 해당하는 셀에 대한 색깔 정의
        public Color ColorByTotalSumCell()
        {
            Color color = Color.FromArgb(217, 217, 217);
            return color;
        }

        //총 합계에 해당하는 셀 중 마지막에 해당하는  색깔 정의
        public Color ColorByLastSumCell()
        {
            Color color = Color.FromArgb(191, 191, 191);
            return color;
        }
    }
}
