...
namespace ComLib
{
    public partial class UC_Zone_B : UserControl
    {
        clsCom ck = new clsCom();
        VbFunc vf = new VbFunc();

        public event EventHandler PopupEvent;
        private string bloomCnt ="";
        ...
        [Description("Bloom CNT"), Category("Contents")]
        ...
        {
            if (this.PopupEvent != null && lb_BloomNo.Text.Length > 0)
                PopupEvent(sender, e);
        }
        ...
        private void SetCursorState(bool isOn)
        {
            if (isOn)
            {
                ...
                SetupLabelCursor(lb_BloomNo, Cursors.Hand);
            ...
            else
            {
                ...
                SetupLabelCursor(lb_BloomNo, Cursors.Default);
