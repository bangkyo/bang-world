...
namespace ComLib
{
    public partial class UC_KeyValueNoT : UserControl
    {
        ...
        private Label defaultUOMLabel;
        private Label defaultLimitLabel;
        private UserControl defaultUC;

        public UC_KeyValueNoT()
        {
            InitializeComponent();
            ...
            defaultTitleLabel = lbTitle;
            defaultValueLabel = lbValue;
            defaultUOMLabel = lbUom;
            defaultLimitLabel = lbLimit;
            defaultUC = this;
        }
        ...
        //[Description("NoTitle"), Category("Contents")]
        //public bool NoTitleNoLimit
        //{
        //    get { return NoTitleNoLimit; } 
        //    set
        //    {
        //        if (value)
        //        {
        //            lbTitle.Width = 0;
        //            lbValue.Location = new Point(1,1);
        //            lbUom.Location = new Point(lbValue.Location.X + lbValue.Size.Width + 1, 1);
        //            lbLimit.Width = 0;
        //            this.Width = lbUom.Location.X + lbUom.Width + 1;
        //        }
        //        else
        //        {
        //            lbTitle = defaultTitleLabel;
        //            lbValue = defaultValueLabel;
        //            lbUom = defaultUOMLabel;
        //            lbLimit = defaultLimitLabel;
        //            //this.Width = defaultUC.Width;
        //        }
