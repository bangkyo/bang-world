CREATE PROCEDURE dbo.SP_IF_MPI_IN
 @P_IF_SEQ    NUMERIC(12)
,@P_TC_CD     VARCHAR(4)  = 'A050'
...
------//프로시져 내부 변수정의//------
DECLARE @ERR_PGM        VARCHAR(50)   = 'SP_IF_MPI_IN';
...
DECLARE @BEF_ZONE_CD    VARCHAR(3) = 'Z20';
        ...
        BEGIN TRAN
            ...
            BEGIN
                ...
                SET     ZONE_CD           = @ZONE_CD
                       ...
                       ,MPI_START_DDTT    = CONVERT(DATETIME,@REG_DDTT)
