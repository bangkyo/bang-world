CREATE PROCEDURE dbo.SP_IF_SHT_DUST_OFF
 @P_IF_SEQ    NUMERIC(12)
,@P_TC_CD     VARCHAR(4)  = 'H020'
...
------//프로시져 내부 변수정의//------
DECLARE @ERR_PGM        VARCHAR(50)   = 'SP_IF_SHT_DUST_OFF';
                ...
                ELSE
                    IF  @SHT_DUST_STAT = 'ON'
                        BEGIN
                            ...
                            SET    SHT_DUST_STAT     = 'OFF'
                                  ,SHT_DUST_OFF_DDTT = @REG_DDTT
