CREATE PROCEDURE [dbo].[SP_IF_CHIP_STR]
 @P_IF_SEQ    NUMERIC(12)
,@P_TC_CD     VARCHAR(4)  = 'F080'
...
------//프로시져 내부 변수정의//------
DECLARE @ERR_PGM        VARCHAR(50)   = 'SP_IF_CHIP_STR';
    ...
    BEGIN TRY
        ...
        BEGIN TRAN
            ...
            BEGIN
                ...
                SET     GRD_CHIP_START_DDTT    = GETDATE()
				       ,GRD_CHIP_REMV_YN       = 'Y';
                IF  @@ROWCOUNT = 0
                    BEGIN
                        INSERT INTO TB_GRD_RBGW_MGMT ( GRD_CHIP_START_DDTT, GRD_CHIP_END_DDTT )
                               VALUES ( GETDATE(), NULL );
                    END;
            END;
