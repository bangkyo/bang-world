CREATE PROCEDURE dbo.SP_IF_GRD_DUST_OFF
 @P_IF_SEQ    NUMERIC(12)
,@P_TC_CD     VARCHAR(4)  = 'K020'
...
------//프로시져 내부 변수정의//------
DECLARE @ERR_PGM        VARCHAR(50)   = 'SP_IF_GRD_DUST_OFF';
                ...
                ELSE
                    IF  @GRD_DUST_STAT = 'ON'
                        BEGIN
                            ...
                            SET    GRD_DUST_STAT     = 'OFF'
                                  ,GRD_DUST_OFF_DDTT = @REG_DDTT
                            INSERT INTO  TB_GRD_DUST_INFO (
                                    WORK_DDTT
                                   ,DUST_ON_TR
                                   ,DUST_OFF_TR
                                  ) VALUES (
