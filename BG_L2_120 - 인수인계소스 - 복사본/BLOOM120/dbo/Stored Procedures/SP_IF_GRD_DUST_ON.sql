CREATE PROCEDURE dbo.SP_IF_GRD_DUST_ON
 @P_IF_SEQ    NUMERIC(12)
,@P_TC_CD     VARCHAR(4)  = 'K010'
...
------//프로시져 내부 변수정의//------
DECLARE @ERR_PGM        VARCHAR(50)   = 'SP_IF_GRD_DUST_ON';
                ...
                IF  @@ROWCOUNT = 0
                    BEGIN
                        INSERT INTO TB_DUST_STAT_MGMT 
                               ( GRD_DUST_STAT, GRD_DUST_ON_DDTT )
                        VALUES ( 'ON', @REG_DDTT );
                    END;
                ELSE
                    IF  @GRD_DUST_STAT <> 'ON'
                        BEGIN
                            ...
                            SET    GRD_DUST_STAT     = 'ON'
                                  ,GRD_DUST_ON_DDTT  = @REG_DDTT
                                  ,GRD_DUST_OFF_DDTT = NULL
                        END;
            END;
